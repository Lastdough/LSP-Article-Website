        ...
        <form method="POST" action="/LSPWebsite/admin/register" class="my-5">
            <div class="flex flex-col space-y-5">
                <label for="username">
                    ...
                    <input id="username" name="username" type="text" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Choose a username">
                </label>
                <label for="name">
                    <p class="font-medium text-slate-700 pb-2">Name</p>
                    <input id="name" name="name" type="text" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your Author name">
                </label>
                <label for="password">
                ...
                <label for="confirmPassword">
                    ...
                    <input id="confirmPassword" name="confirmPassword" type="password" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Confirm your password">
                </label>
